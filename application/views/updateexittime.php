...
?><br><br>
            ...
            <input type="text"  name="entime" value="<?php echo $data->EntryTime;?>"><br><br>
            <label>Exit Time</label>
            <input type="text"  name="extime" value="<?php echo $data->ExitTime;?>"><br><br>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
	<script>
		$("#editForm").submit(function (event) {
			...
			$.ajax({
				url: "<?php echo base_url('index.php/visitor/updateexittime/'.$data->id)?>",
